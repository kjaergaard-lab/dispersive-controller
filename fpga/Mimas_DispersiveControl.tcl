# 
# Project automation script for Mimas_DispersiveControl 
# 
# Created for ISE version 14.7
# 
# This file contains several Tcl procedures (procs) that you can use to automate
# your project by running from xtclsh or the Project Navigator Tcl console.
# If you load this file (using the Tcl command: source Mimas_DispersiveControl.tcl), then you can
...
set myProject "Mimas_DispersiveControl"
set myScript "Mimas_DispersiveControl.tcl"
...
proc add_source_files {} {
   ...
   xfile add "../vhdl/CustomTypes.vhd"
   xfile add "../vhdl/DispersiveControl_tb.vhd"
   xfile add "../vhdl/Dispersive_Control.vhd"
   xfile add "../vhdl/PulseGen.vhd"
   xfile add "../vhdl/ReadData.vhd"
   xfile add "../vhdl/Serial.vhd"
   xfile add "../vhdl/SerialCommunication.vhd"
   xfile add "../vhdl/UART_Receiver.vhd"
   xfile add "../vhdl/UART_Transmitter.vhd"
   xfile add "../vhdl/topmod.vhd"
   xfile add "ipcore_dir/DCM1.xco"
   xfile add "mimas_constraints.ucf"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Target UCF File Name" "/home/nkgroup/Xilinx/mimas-dispersive-control/fpga/mimas_constraints.ucf" -process "Back-annotate Pin Locations"
   ...
   project set "Work Directory" "/home/nkgroup/Xilinx/mimas-dispersive-control/fpga/xst" -process "Synthesize - XST"
